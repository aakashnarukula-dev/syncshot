 ...
 * this includes an AccessibilityService. Verified on-device: when SyncShot is in the
 ...
 * service on the primary-clip-changed callback) only works while SyncShot is in focus.
 *
...
class ClipboardCaptureService : AccessibilityService() {
    ...
    private fun onClipChanged(cm: ClipboardManager) {
        ...
        // Try a direct read. Succeeds only when SyncShot is the focused app.
