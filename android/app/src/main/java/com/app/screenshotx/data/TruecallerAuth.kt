...
import com.app.screenshotx.BuildConfig
 ...
 * server-to-server. The ScreenshotX server (screenshotx-server.vercel.app)
...
object TruecallerAuth {
    private const val BASE = "https://screenshotx-server.vercel.app"
    ...
    suspend fun init(): Session = withContext(Dispatchers.IO) {
        ...
        Session(
            ...
            partnerName = json.optString("partnerName", "ScreenshotX"),
        )
    }
