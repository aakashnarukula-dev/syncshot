...
const features = [
  {
    title: "How to Install SyncShot",
    description: "Follow these simple steps to install SyncShot on your Mac.",
    demoVideo: "GnQRUWiFx9Y",
  },
  {
    title: "Best Way to Use SyncShot",
    description: "Learn tips and tricks to get the most out of SyncShot.",
