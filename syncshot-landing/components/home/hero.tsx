      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full pt-28 sm:pt-36 lg:pt-55">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-start">
          <div className="flex flex-col">
            <div className="mb-6">
            <a
          href="https://peerlist.io/code_kartik/project/syncshot--free-screenshot-tool-for-macos"
          target="_blank"
          rel="noreferrer"
        ...
        >
          <img
            ...
            alt="SyncShot - Free Screenshot Tool for macOS"
          ...
          />
            ...
            >
              ...
              <HeroVideoDialog
                ...
                thumbnailAlt="SyncShot Demo Video"
