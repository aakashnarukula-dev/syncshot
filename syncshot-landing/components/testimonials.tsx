...
const testimonials = [
  {
    name: "Alex Chen",
    username: "@alexdev",
    body: "SyncShot replaced CleanShot X for me. It's free, fast, and has everything I need for professional screenshots.",
      ...
      <div className="mx-auto max-w-7xl">
        <div className="mx-auto max-w-[540px]">
          ...
          <p className="mt-5 relative z-10 text-center text-lg text-zinc-500">
            Join developers and creators who use SyncShot to capture and enhance their screenshots every day.
          </p>
        </div>
        ...
        <div className="-mt-8 flex justify-center">
          <a
            href="https://github.com/aakashnarukula-dev/syncshot"
            target="_blank"
